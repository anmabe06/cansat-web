...
from Writers import FileWriter, ConsoleWriter, SQLWriter
...
def get_port():
    ...
    for onePort in ports:
        print(f"    --> {onePort}")
    return input("Name of the selected port: ")
...
if __name__ == '__main__':
    ...
    if args.simulate != "":
        ...
        serialport = get_port()
        launch = Launch(args.mysqlhost, args.mysqluser, args.mysqlpassword, args.mysqldatabase, args.mysqldrop, serialport, args.baudrate, args.serialtimeout)
        launch.start()
